...
> can be found [here](https://github.com/meta-quick/opax-envoy-plugin/tree/main/examples/envoy-uds).
...
and prepare the result. Basically this is time spent by the OPA-Envoy plugin to process the request. OPA's [metrics](https://pkg.go.dev/github.com/meta-quick/opax/metrics)
