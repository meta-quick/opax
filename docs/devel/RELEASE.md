...
1. Open browser and go to [https://github.com/meta-quick/opax/releases](https://github.com/meta-quick/opax/releases)

1. Update the draft release (may take up to 20 min for the draft to become
   available, track its process under
   [https://github.com/meta-quick/opax/actions](https://github.com/meta-quick/opax/actions)).
